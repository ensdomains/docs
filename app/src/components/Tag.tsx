...
const colorStyles = {
    emerald: {
        small: 'text-ens-light-blue-500 dark:text-ens-light-blue-400',
        medium: 'ring-ens-300 dark:ring-ens-400/30 bg-ens-light-blue-400/10 text-ens-light-blue-500 dark:text-ens-light-blue-400',
    },
    sky: {
        small: 'text-sky-500',
