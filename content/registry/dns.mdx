...
You can learn more about [how to import a DNS name](/learn/dns#importing-a-dns-name) in the DNS section, or see how to [programatically complete these steps](#programming-dnssec-proofs).
...
- [ENSjs](https://github.com/ensdomains/ensjs-v3) = A library for interacting with ENS smart contracts
