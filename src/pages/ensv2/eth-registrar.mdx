...
<ContractReference functions={[
  ...
  },
  {
    ...
    params: [
      { name: 'rd', type: 'RenewData', description: 'Renewal data: (label, duration, referrer)' },
      { name: 'paymentToken', type: 'IERC20', description: 'ERC20 token to pay with' },
    ],
  },
  {
    name: 'renewBatch',
    description: 'Renew multiple names in one transaction, paid with a single token.',
    params: [
      { name: 'rds', type: 'RenewData[]', description: 'Renewal data per name: (label, duration, referrer)' },
      { name: 'paymentToken', type: 'IERC20', description: 'ERC20 token to pay with' },
    ],
  },
  {
...
<ContractReference functions={[
  ...
  {
    name: 'getRenewPrice',
    description: 'Get the renewal price for a name (base rate only, no premium). Reverts NameNotRenewable if the name is not currently renewable.',
    params: [
      { name: 'label', type: 'string', description: 'The label to price' },
      { name: 'duration', type: 'uint64', description: 'Duration in seconds' },
      { name: 'paymentToken', type: 'IERC20', description: 'Token to price in' },
...
<ContractReference functions={[
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'referrer', type: 'bytes32', indexed: true, description: 'Referral identifier' },
