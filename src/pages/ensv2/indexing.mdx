...
The contracts and interfaces described here are **not yet final** and may change prior to mainnet deployment. In particular, [indexer-breaking changes to the resolver event model](https://gist.github.com/makoto/37d1e78c03c6f608a6bd280a181695d0#-indexer-breaking-resolver-event-model-replaced-pr-354) will be merged soon. This page describes the [current Sepolia deployment](/learn/deployments#sepolia-ensv2-beta).
</FrenCallout>
