...
Sepolia runs the [ENSv2](/ensv2/overview) contracts: the [Universal Resolver](/ensv2/universal-resolver-v2) and the ENS apps for Sepolia resolve through this deployment. Interact with it via the [ENS App](https://app.ens.dev) and the [ENS Explorer](https://explorer.ens.dev).
