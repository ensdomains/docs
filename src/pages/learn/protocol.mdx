...
ENS also supports 'reverse resolution,' which allows metadata such as primary names or interface descriptions to be associated with Ethereum addresses.
...
Registration is done through smart contracts, and the Ethereum blockchain secures name ownership.
...
Users can create subdomains manually or take matters into their own hands and write their resolution logic.
