...
The resolution process involves multiple parts. Most notably the [Registry](/v1/registry), multiple Registrars ([ETH Registrar](/v1/eth-registrar), [DNS Registrar](/registry/dns), [Reverse Registrar](/registry/reverse), etc)
...
To get the resolver responsible for a name, you can query [The Registry](/v1/registry) for the `resolver` of a name.
