...
In the [Use Cases](/v1/wrapper/usecases#sell-or-rent-subnames) section, we talked about the ability to stand up your own "registrar" to allow other people to register/claim subnames automatically. Maybe you want to give wrapped subnames out for free, or maybe you want to charge for them. Maybe you want to apply specific rules to the subnames, such as only allowing alphanumeric names. All of this is possible, and this article will break down what you need to do.

It's recommended to first read the [Use Cases](/v1/wrapper/usecases#sell-or-rent-subnames) section to get an overview of the decisions you'll need to make.
...
If you want to issue [Emancipated](/v1/wrapper/states#emancipated) subnames, or subnames with [any other fuses](/v1/wrapper/fuses) burned, then your parent name must first be [Locked](/v1/wrapper/states#locked). You can do this on the Permissions tab in the ENS manager app.
...
- ttl: 0
- fuses: Up to you and your goals. See the [Use Cases](/v1/wrapper/usecases#sell-or-rent-subnames) section for a discussion on this. Typically 65536 for an enamcipated rental subname, or 327680 for an emancipated "forever" name.
...
This will only apply to you if you have a specific `setupDomain` method or something similar on your contract, such as the [reference implementation](/v1/wrapper/creating-subname-registrar#reference-implementation) contracts do.
