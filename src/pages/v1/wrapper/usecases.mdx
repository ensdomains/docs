...
Then, burn the **`CANNOT_APPROVE`** fuse on your name, to guarantee that you can never revoke that contract for subname renewals. See [Approved Operators](/v1/wrapper/contracts/#approved-operators) for more info.
...
See this page for a step-by-step guide on creating and setting up your own subname registrar: [Creating a Subname Registrar](/v1/wrapper/creating-subname-registrar)

There is even a set of [reference implementation contracts](/v1/wrapper/creating-subname-registrar#reference-implementation) you can use as a starting base!
