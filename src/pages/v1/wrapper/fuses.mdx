...
| **`CAN_EXTEND_EXPIRY`**     | The owner of the child name will be able to extend their own expiry. Normally, only the parent owner can extend the expiry of a child name. See the [Expiry](/v1/wrapper/expiry) section for more information.                                                                                      |
...
This is also covered in the [Wrapped States](/v1/wrapper/states) section, but here is a quick recap:
