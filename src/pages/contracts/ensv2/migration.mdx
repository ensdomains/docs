...
| `BONUS_PERIOD` | 62 days | `GRACE_PERIOD_V1 - GRACE_PERIOD_V2`. Added to v1 expiry during premigration so that a name becomes available in v2 no earlier than in v1 |
...
The RESERVED slot has 1 day left (-61 + 62). The owner uses `ETHRenewerV1` to renew for 62 days. ENSv1 expires after 1 day (-61 + 62) and becomes available after 91 days. ENSv2 expires after 63 days (-61 + 62 + 62) and becomes available after 91 days. The token can now be transferred and migrated.
