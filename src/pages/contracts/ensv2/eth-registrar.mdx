...
**Expiry premium**: after the 28-day grace period, recently-expired names enter a temporary premium period to prevent sniping. The premium starts high and decreases over time. The previous owner can re-register during the premium period **without paying the premium**.
...
The **BatchRegistrar** is a companion contract used during migration from ENSv1. It allows the deployer to batch-register or batch-renew names in a single transaction:
