...
If you'd like to issue L1 subnames to your users, read our guide on [creating an onchain subname registrar](/v1/wrapper/creating-subname-registrar).

<EmbedLink
  title="Creating an Onchain Subname Registrar"
  href="/v1/wrapper/creating-subname-registrar"
