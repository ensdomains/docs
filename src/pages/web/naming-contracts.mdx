...
For most regular wallets you can set your primary name from within the [Manager App](https://ens.domains). However also smart contracts can have names, and even better they can have primary names.
