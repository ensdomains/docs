...
- Atomic deployment and naming using `CREATE2`
- ENS subname creation and forward resolution
- Primary name (reverse record) assignment for contracts implementing `Ownable`, `ERC173`, or `ReverseClaimer`
