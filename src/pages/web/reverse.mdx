...
:::warning
As of August 12, 2025, no library has been updated to support L2 Primary Names. Refer to [this temporary reference implementation](https://github.com/ensdomains/frontend-template/blob/main/src/hooks/useEnsName.ts).
:::
