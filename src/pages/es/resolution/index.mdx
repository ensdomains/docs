...
Ten en cuenta que muchas librerías ya tienen funcionalidad para hacer esto. Puedes leer más sobre esto en la sección [Obteniendo un Nombre Primario](/es/web/reverse).
