...
| **Votes**             | [Snapshot](https://vote.ensdao.org/#/onchain/107313977323541760723614084561841045035159333942448750767795024713131429640046), [Anticapture](https://app.anticapture.com/ens/governance/proposal/107313977323541760723614084561841045035159333942448750767795024713131429640046) |

## Abstract

Following the approval of the [\[Executable\] Collective Working Group Funding Request (Oct 2025)](https://vote.ensdao.org/#/onchain/77525093718307720477107269225240955392442633055266271196124066559357053541713), the transactions included in that proposal cannot fully execute due to insufficient USDC in the ENS DAO timelock (`wallet.ensdao.eth`).
