...
This proposal suggests introducing and implementing an [Investment Policy Statement (IPS)](https://github.com/ensdomains/docs/blob/master/public/governance/dao-investment-policy.pdf) for the ENS Endowment.
...
The creation and implementation of the [IPS](https://github.com/ensdomains/docs/blob/master/public/governance/dao-investment-policy.pdf), will serve the following purposes:
...
The proposed ENS Investment Policy Statement to be ratified can be read [here](https://github.com/ensdomains/docs/blob/master/public/governance/dao-investment-policy.pdf).
