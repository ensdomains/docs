...
The Security Council's cancel authority is time-limited. Two years after deployment (at unix timestamp `1784919179`), any address may call `revoke()` to permanently disable the cancel role, promoting decentralisation over time.
