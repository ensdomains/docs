...
- [ ] Update the forum thread:
  - [ ] Remove the Snapshot link at the top.
...
- [ ] Construct the executable proposal on the interface of your choice, such as [Snapshot](https://vote.ensdao.org/), following the instructions in the proposal.
...
- [ ] Add a link to the vote on Snapshot to the top of the proposal on the forum thread.
- [ ] Update the status of the proposal in the governance docs to 'Active'.
- [ ] Send a forum DM to the 'delegates' group announcing the proposal is up for execution, with a link to the Snapshot proposal page.
- [ ] Send a tweet announcing that the proposal is up for voting.
