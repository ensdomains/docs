...
[Snapshot](https://vote.ensdao.org) and [Anticapture](https://app.anticapture.com/ens) are governance portals that allow token holders to delegate their votes, and allow delegates to create and vote on binding proposals.
...
1.  Write a draft RFP ([template here](https://github.com/ensdomains/docs/blob/master/public/governance/rfp-template.md)) and post it as a discussion thread in the appropriate working group on [the DAO forum](https://discuss.ens.domains/). At a minimum, RFPs must:
