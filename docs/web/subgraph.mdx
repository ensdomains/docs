...
One can explore the following examples interactively via the [Graph Explorer Playground](https://thegraph.com/explorer/subgraphs/EjtE3sBkYYAwr45BASiFp8cSZEvd1VHTzzYFvJwQUuJx?view=Playground&chain=mainnet)
