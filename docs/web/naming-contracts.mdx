...
Naming smart contracts is cool. Lorem ipsum dolor sit amet.
...
If you a developing a new contract, and you want to be able to easily set the ENS Primary Name for it.
...
If your smart-contract implements [Ownable](https://docs.openzeppelin.com/contracts/5.x/api/access#Ownable) from OpenZeppelin, you use the tool below on this page!
As the ReverseRegistrar implements support for the Ownable interface.
