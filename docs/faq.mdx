...
3 and 4 character names have higher pricing to reflect the small number of these names available. [Read more about pricing](/registry/eth#pricing-structure).
