...
```jsx {{ title: "ensjs", link: "https://github.com/ensdomains/ensjs" }}
import { namehash } from '@ensdomains/ensjs/utils';

const node = namehash('name.eth');
```

```python {{ title: "ens-namehash-py", link: "https://github.com/ConsenSysMesh/ens-namehash-py" }}
...
The specification for the namehash algorithm was originally defined in [EIP-137](https://eips.ethereum.org/EIPS/eip-137#namehash-algorithm).
