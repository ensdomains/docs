...
<div className="card1 p-4">
  <div className="aspect-video h-32 mx-auto border border-ens-light-border dark:border-ens-dark-border rounded-xl">
    <svg className="w-full h-full" width="160" height="90" viewBox="0 0 160 90">
...
// Controller
event NameRegistered(string name, indexed bytes32 label, indexed address owner, uint256 baseCost, uint256 premium, uint256 expires);
