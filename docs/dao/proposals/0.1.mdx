...
- Discuss this proposal on the ENS [Forum](https://discuss.ens.domains/) and [Discord](https://chat.ens.domains/).
- Implement a vote on this proposal on [Snapshot](https://snapshot.box/#/s:ens.eth).
- If passed:
