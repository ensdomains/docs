export const meta = {
  ...
  proposal: {
    discourse: '10053',
    snapshot:
      '0xdf7e59e58ab0cf5ee0a591bd65369db3ee5091ae3b7ca696a0d31c2eac9959f5',
    tally:
      '82659277767818009782194204088226418907972756681918239480374274857360772298879',
    type: 'executable',
  },
}
...
<Note>This screenshot could not be found</Note>
