export const meta = {
  description:
    'A proposal to fund TNL for continuing development and improvement of the ENS system.',
  emoji: '📙',
  contributors: ['khori-eth'],
  proposal: {
    discourse: '13391',
    tally:
      '112764562576314516994943312429834673309292069549953740415731020720942627228986',
  },
}
