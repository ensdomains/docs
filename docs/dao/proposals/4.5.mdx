export const meta = {
  description:
    'This proposal introduces new actions and strategies to the Endowment with the aim of enhancing diversification and adapting to current market conditions. Notable additions include ETH-neutral strategy.',
  emoji: '📖',
  contributors: ['karpatkey'],
  proposal: {
    discourse: '18036',
    type: 'executable',
    tally:
