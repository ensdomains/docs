export const meta = {
  ...
  emoji: '📗',
  contributors: ['coltron-code'],
  proposal: {
    discourse: '11046',
    snapshot:
      '0x29040b3196c4d7109fdb7b55b8bfd5e85dd074d3cb22266e0d94cc42cfad1eb2',
    tally:
...
**Note:** This includes subgroups and supports moderation of the [ENS Discord](https://chat.ens.domains/). The Discord moderation is a necessary DAO expense carried by the community working group.
