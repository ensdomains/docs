...
export const meta = {
    description: 'This proposal seeks to implement the revised budget stream to ENS Labs develop, maintain and audit ENSv2.',
    emoji: '📖',
    contributors: [
        'kathereineykwu.eth'
    ],
    proposal: {
        snapshot: '33504840096777976512510989921427323867039135570342563123194157971712476988820',
        discourse: 'https://discuss.ens.domains/t/ep-5-22-ensv2-development-funding-request/19762',
        type: 'executable'
    }
};
