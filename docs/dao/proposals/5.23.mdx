...
export const meta = {
    ...
    proposal: {
        snapshot: '46071186312489687574960948336391811341595411932836110873328798657006776570015',
        discourse: 'https://discuss.ens.domains/t/ep-5-23-executable-governance-security-bounty/19803?u=estmcmxci',
        type: 'executable'
    }
};
