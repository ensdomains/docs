...
export const meta = {
    ...
    description: 'Learn about how CCIP Read enabled Offchain ENS Resolvers, how a gateway works, trust assumptions, and more.',
    emoji: '⛓️',
...
A testing tool for CCIP functions will be available soon.
