...
```typescript {{ variant: "ensjs", link: "https://github.com/ensdomains/ensjs-v3/blob/feat/viem/docs/wallet/function.setRecords.md" }}
...
```typescript {{ variant: "ensjs", link: "https://github.com/ensdomains/ensjs-v3/blob/feat/viem/docs/wallet/function.setResolver.md" }}
import { createWalletClient, custom } from 'viem'
import { mainnet } from 'viem/chains'
import { addEnsContracts } from '@ensdomains/ensjs'
